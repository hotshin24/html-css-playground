...
export const CONDITION_TYPES = [
  ...
  },
  {
    ...
    status: "active",
    scope: "section",
    check: "구역 내 모든 `img`에 `alt` 속성이 존재하는지",
    acceptCardinality: "none",
    acceptKeys: [],
    rationale: "접근성 필수 요건",
  },
  ...
  },
  {
    ...
    status: "active",
    scope: "section",
    check: "구역 내 모든 입력 요소에 `label`이 연결되었는지",
    acceptCardinality: "none",
    acceptKeys: [],
    rationale: "접근성 필수 요건",
  },
